<div class="topmenu">
	<g:if test="${session.member}">
			...
			<g:form name="process" controller="page" action="process"><button type="submit" name="msnfiles" value="submit" class="cupid-green"><g:message code="menu.process" /></button></g:form>
			<g:form name="database" controller="page" action="database"><button type="submit" name="msnfiles" value="submit" class="cupid-green"><g:message code="menu.databases" /></button></g:form>
			<g:form name="query" controller="page" action="query"><button type="submit" name="msnfiles" value="submit" class="cupid-green"><g:message code="menu.query.file" /></button></g:form>
